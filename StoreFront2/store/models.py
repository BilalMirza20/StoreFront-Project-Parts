...
class OrderItem(models.Model):
    order = models.ForeignKey(Order, on_delete=models.PROTECT)  # if we accidentally delete an order we don't end up deleting the OderItems so if an order have at least one OrderItem we will not be able to delete it.
